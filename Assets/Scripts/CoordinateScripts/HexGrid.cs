...
public class HexGrid : MonoBehaviour
{
    ...
    {
        public static List<Vector3Int> directOffsetOdd = new List<Vector3Int>
        {
        ...
        public static List<Vector3Int> directOffsetEven = new List<Vector3Int>
        {
        ...
        public static List<Vector3Int> GetDirectionList(int z)
           => z % 2 == 0 ? directOffsetEven : directOffsetOdd;
